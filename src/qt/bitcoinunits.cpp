...
QList<BitcoinUnit> BitcoinUnits::availableUnits()
{
    ...
    // Nur die beiden Einheiten, die wir wirklich benutzen:
    unitlist.append(Unit::BTC); // MFLEX
    unitlist.append(Unit::SAT); // FLEXIS
    return unitlist;
}
...
QString BitcoinUnits::longName(Unit unit)
{
    ...
    case Unit::BTC:
        // Haupteinheit
        return QString("MFLEX");
    case Unit::mBTC:
        // Nicht in availableUnits(), aber für Vollständigkeit definieren
        return QString("mMFLEX");
    case Unit::uBTC:
        return QString::fromUtf8("µMFLEX");
    case Unit::SAT:
        // Kleinste Einheit
        return QString("FLEXIS");
...
QString BitcoinUnits::description(Unit unit)
{
    ...
    case Unit::BTC:
        return QString("MFLEX");
    case Unit::mBTC:
        return QString("Milli-MFLEX (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC:
        return QString("Mikro-MFLEX (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    case Unit::SAT:
        return QString("FLEXIS (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000 MFLEX)");
    } // no default case, so the compiler can warn about missing cases
    assert(false);
}
...
{
    switch (unit) {
    case Unit::BTC: return 100'000'000; // 1 MFLEX = 100 Mio FLEXIS
    case Unit::mBTC: return 100'000;
    case Unit::uBTC: return 100;
    case Unit::SAT: return 1;          // 1 FLEXIS
    } // no default case, so the compiler can warn about missing cases
    assert(false);
}
...
{
    switch (unit) {
    case Unit::BTC: return 8; // 8 Nachkommastellen bei MFLEX
    case Unit::mBTC: return 5;
    case Unit::uBTC: return 2;
    case Unit::SAT: return 0; // FLEXIS als ganze Zahl
    } // no default case, so the compiler can warn about missing cases
    assert(false);
}
