      ...
      platformStyle(_platformStyle)
{
    ...
    loyaltyPage = new LoyaltyPage(platformStyle);
    loyaltyPage->setWalletModel(walletModel);
...
void WalletView::setClientModel(ClientModel *_clientModel)
{
    ...
    loyaltyPage->setClientModel(_clientModel);
...
void WalletView::gotoLoyaltyPage()
{
    setCurrentWidget(loyaltyPage);
}
