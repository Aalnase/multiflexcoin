...
void BitcoinGUI::createActions()
{
    ...
    loyaltyAction = new QAction(tr("&Loyalty"), this);
    loyaltyAction->setStatusTip(tr("Show Loyalty page"));
    loyaltyAction->setToolTip(loyaltyAction->statusTip());
    loyaltyAction->setCheckable(true);
    loyaltyAction->setShortcut(QKeySequence(QStringLiteral("Alt+2")));
    loyaltyAction->setIcon(QIcon(":/icons/mflex_levels/miner_level_01.png"));
    tabGroup->addAction(loyaltyAction);

    sendCoinsAction = new QAction(platformStyle->SingleColorIcon(":/icons/send"), tr("&Send"), this);
    sendCoinsAction->setStatusTip(tr("Send coins to a Bitcoin address"));
    sendCoinsAction->setToolTip(sendCoinsAction->statusTip());
    sendCoinsAction->setCheckable(true);
    sendCoinsAction->setShortcut(QKeySequence(QStringLiteral("Alt+3")));
    ...
    receiveCoinsAction->setShortcut(QKeySequence(QStringLiteral("Alt+4")));
    ...
    connect(loyaltyAction, &QAction::triggered, this, &BitcoinGUI::gotoLoyaltyPage);
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->addAction(loyaltyAction);
...
void BitcoinGUI::setWalletActionsEnabled(bool enabled)
{
    ...
    loyaltyAction->setEnabled(enabled);
...
void BitcoinGUI::gotoLoyaltyPage()
{
    loyaltyAction->setChecked(true);
    if (walletFrame) walletFrame->gotoLoyaltyPage();
}
