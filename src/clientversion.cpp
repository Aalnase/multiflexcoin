 ...
 *
 * MFLEX: Hier setzen wir unseren eigenen Namen, der im User-Agent
 * und in getnetworkinfo.subversion auftaucht.
 */
const std::string UA_NAME("Multiflex");
...
{
    // TODO (MFLEX): Hier kannst du später deine eigene Repo-/Projekt-URL eintragen.
    // Z.B.: "<https://github.com/deinuser/multiflex-core>"
