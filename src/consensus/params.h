...
struct Params {
    ...
    // MFLEX Jackpot / Lottery consensus parameters
    // Height at which Jackpot reserve/bonus starts (0/1 to enable from genesis)
    int H_jp_start{0};
    // Height at which Lottery reserve starts (0 = disabled)
    int H_lot_start{0};
    /**
